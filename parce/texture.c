...
/*   Updated: 2022/08/22 15:45:56 by rgatnaou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "parce.h"
int valid_texture(int *t)
{
...
int check_color_rang(char **tex,int *nb)
{
    ...
    while (tex[i])
    {
        ...
        {
            *nb += 1;
            return (ft_error("error : the color is out of range {0,255}.\n",NULL));
        }
        i++;
    }
    return (0);
